...
class AnaliseProfunda:
    ...
    def __init__(self):
        self.df = pd.read_excel('dados/coletaDeDados.xlsx') # Alterar quando passar para a WEB
...
#instancia.idiomasFalados()
#instancia.idiomasTraduzidos()
instancia.picosDeAcesso()